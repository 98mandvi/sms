...
<body>
	...
	<span id="top_span"><marquee>Note:- This portal is open till 10 May 2023...Plz edit your information, if wrong.</marquee></span>
	<div id="left_side">
		<br><br><br>
	...
	<div id="right_side"><br><br>
		...
		<?php
			if(isset($_POST['delete_student']))
			{
				?>
				<center id="RSRA2" >
				<form action="mandvi_delete_student.php" method="post">
				&nbsp;&nbsp;<b>Enter Roll No:</b>&nbsp;&nbsp; <input type="text" name="roll_no">
			...
			<?php 
				if(isset($_POST['add_new_student'])){
					...
					<form action="mandvi_add_student.php" method="post">
						<table>
						<tr>
							<td>
								<b>Roll No:</b>
